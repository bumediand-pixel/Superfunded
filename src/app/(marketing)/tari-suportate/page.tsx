      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="mb-14">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="font-mono text-xs tracking-[0.22em] uppercase" style={{ color: 'var(--red)' }}>Global</span>
          </div>
          <h1 className="font-bebas leading-none mb-4" style={{ fontSize: 'clamp(48px, 8vw, 96px)', letterSpacing: '0.03em' }}>
            ȚĂRI<br/>SUPORTATE
          </h1>
          <p className="text-sm leading-relaxed max-w-lg" style={{ color: 'var(--white-mid)' }}>
        ...
        <div className="space-y-12 text-sm leading-relaxed" style={{ color: 'var(--white-mid)' }}>
          ...
          <section>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="font-bebas text-2xl tracking-wider" style={{ color: 'var(--white-hi)', letterSpacing: '0.05em' }}>ȚĂRI ACCEPTATE</h2>
              <span className="font-mono text-xs" style={{ color: 'rgba(255,255,255,0.3)' }}>{TARI_ACCEPTATE.length} țări</span>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
              {TARI_ACCEPTATE.sort().map((tara) => (
                <div key={tara} className="flex items-center gap-2 px-3 py-2" style={{ background: 'var(--black-2)', border: '1px solid rgba(255,255,255,0.04)' }}>
          ...
          <section>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="font-bebas text-2xl tracking-wider" style={{ color: 'var(--white-hi)', letterSpacing: '0.05em' }}>ȚĂRI RESTRICȚIONATE</h2>
              <span className="font-mono text-xs" style={{ color: 'rgba(255,255,255,0.3)' }}>{TARI_RESTRICTIONATE.length} jurisdicții</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
              {TARI_RESTRICTIONATE.map((tara) => (
                <div key={tara} className="flex items-center gap-2 px-3 py-2" style={{ background: 'var(--black-2)', border: '1px solid rgba(230,57,70,0.1)' }}>
                  <span style={{ color: 'var(--red)', fontSize: '8px' }}>●</span>
                  <span className="text-xs" style={{ color: 'rgba(255,255,255,0.5)' }}>{tara}</span>
                </div>
              ))}
            </div>
          </section>
          ...
          <section>
            <h2 className="font-bebas text-2xl tracking-wider mb-4" style={{ color: 'var(--white-hi)', letterSpacing: '0.05em' }}>CONFORMITATE KYC/AML</h2>
