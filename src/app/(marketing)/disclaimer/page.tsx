    ...
    <div className="min-h-screen py-32" style={{ background: 'var(--bg-alt, #fbf8f6)' }}>
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-10 text-sm leading-relaxed" style={{ color: 'var(--text-muted, #64748b)' }}>
          ...
          <section>
            <h2 className="font-extrabold tracking-tight text-2xl tracking-wider mb-4" style={{ color: 'var(--text, #0f172a)', letterSpacing: '0.05em' }}>2. RISCURI ASOCIATE</h2>
          ...
          <section>
            <h2 className="font-extrabold tracking-tight text-2xl tracking-wider mb-4" style={{ color: 'var(--text, #0f172a)', letterSpacing: '0.05em' }}>3. JOCUL RESPONSABIL</h2>
            ...
            <div className="mt-4 space-y-3">
              {[
                ...
                <div key={i} className="flex gap-4 p-3" style={{ background: '#ffffff', border: '1px solid var(--border, #e2e8f0)' }}>
                  <span className="font-semibold text-xs font-bold shrink-0 mt-0.5" style={{ color: 'var(--red)' }}>{item.org}</span>
                  <span>{item.desc}</span>
                </div>
              ))}
            </div>
            <p className="mt-4 font-semibold" style={{ color: 'var(--text, #0f172a)' }}>Vârsta minimă pentru utilizarea platformei noastre este de 18 ani.</p>
          </section>
