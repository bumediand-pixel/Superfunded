      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-10 text-sm leading-relaxed" style={{ color: 'var(--text-muted, #64748b)' }}>
          ...
          <div className="p-5" style={{ background: 'rgba(230,57,70,0.06)', border: '1px solid rgba(230,57,70,0.2)' }}>
            <p className="font-semibold" style={{ color: 'var(--text, #0f172a)' }}>Rezumat important:</p>
          ...
          <section>
            <h2 className="font-extrabold tracking-tight text-2xl tracking-wider mb-4" style={{ color: 'var(--text, #0f172a)', letterSpacing: '0.05em' }}>1. TAXA DE EVALUARE — POLITICA GENERALĂ</h2>
            <p>Prin achiziționarea unui Challenge SuperFunded, ești de acord că taxa plătită este <strong style={{ color: 'var(--text, #0f172a)' }}>nerambursabilă</strong> în circumstanțe normale.</p>
          ...
          <section>
            <h2 className="font-extrabold tracking-tight text-2xl tracking-wider mb-4" style={{ color: 'var(--text, #0f172a)', letterSpacing: '0.05em' }}>2. RECUPERAREA TAXEI PRIN PRIMA RETRAGERE</h2>
            ...
            <ul className="list-none mt-4 space-y-3">
              <li className="flex items-start gap-3 p-3" style={{ background: '#ffffff', border: '1px solid var(--border, #e2e8f0)' }}>
                <span className="font-semibold text-xs font-bold shrink-0" style={{ color: 'var(--red)' }}>01</span>
                <span>Treci evaluarea și primești contul finanțat</span>
              </li>
              <li className="flex items-start gap-3 p-3" style={{ background: '#ffffff', border: '1px solid var(--border, #e2e8f0)' }}>
                <span className="font-semibold text-xs font-bold shrink-0" style={{ color: 'var(--red)' }}>02</span>
                <span>Soliciți prima retragere din contul finanțat</span>
              </li>
              <li className="flex items-start gap-3 p-3" style={{ background: '#ffffff', border: '1px solid var(--border, #e2e8f0)' }}>
                <span className="font-semibold text-xs font-bold shrink-0" style={{ color: 'var(--red)' }}>03</span>
                <span>Prima retragere include automat suma taxei de challenge plătite + profitul tău</span>
              </li>
            </ul>
            <p className="mt-4">Exemplu: ai plătit €139 pentru un challenge de €10.000 (2-Step) și ai generat €2.000 profit. Prima ta retragere va fi: €139 (rambursare taxă) + €1.600 (80% din €2.000 profit) = <strong style={{ color: 'var(--text, #0f172a)' }}>€1.739</strong>.</p>
          </section>

          <section>
            <h2 className="font-extrabold tracking-tight text-2xl tracking-wider mb-4" style={{ color: 'var(--text, #0f172a)', letterSpacing: '0.05em' }}>3. EXCEPȚII — CÂND PROCESĂM RAMBURSĂRI</h2>
            ...
            <p className="mt-4">Pentru a solicita o rambursare în baza excepțiilor de mai sus, contactează echipa de suport la <span style={{ color: 'var(--text, #0f172a)' }}>support@thesuperfunded.com</span> în termen de 7 zile de la data tranzacției, furnizând dovezile relevante.</p>
          </section>

          <section>
            <h2 className="font-extrabold tracking-tight text-2xl tracking-wider mb-4" style={{ color: 'var(--text, #0f172a)', letterSpacing: '0.05em' }}>4. SITUAȚII CARE NU BENEFICIAZĂ DE RAMBURSARE</h2>
            <ul className="list-none space-y-2">
              {[
                ...
                <li key={i} className="flex items-start gap-3">
                  <span style={{ color: 'var(--text-muted, #64748b)', marginTop: '2px', flexShrink: 0 }}>—</span>
                  <span>{item}</span>
                </li>
              ))}
            </ul>
          ...
          <section>
            <h2 className="font-extrabold tracking-tight text-2xl tracking-wider mb-4" style={{ color: 'var(--text, #0f172a)', letterSpacing: '0.05em' }}>5. REDUCERE LA REÎNCERCARE</h2>
            <p>Dacă nu reușești evaluarea, poți reîncerca cu o <strong style={{ color: 'var(--text, #0f172a)' }}>reducere de 20%</strong> față de taxa originală. Această reducere se aplică automat la achiziția unui nou challenge de același tip și dimensiune.</p>
          ...
          <section>
            <h2 className="font-extrabold tracking-tight text-2xl tracking-wider mb-4" style={{ color: 'var(--text, #0f172a)', letterSpacing: '0.05em' }}>6. PROCESUL DE RAMBURSARE</h2>
          ...
          <section>
            <h2 className="font-extrabold tracking-tight text-2xl tracking-wider mb-4" style={{ color: 'var(--text, #0f172a)', letterSpacing: '0.05em' }}>7. CONTACT PENTRU RAMBURSĂRI</h2>
