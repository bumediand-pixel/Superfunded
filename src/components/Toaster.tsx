'use client';
/**
 * Toaster — minimal, zero-dep toast system.
 *
 *   <Toaster />                         // mount once near the app root
 *   import { toast } from '@/components/Toaster';
 *   toast.error('Plata a eșuat');
 *   toast.success('Cont creat');
 *   toast('Mesaj neutru');
 *
 * Toasts are appended to a module-level EventTarget; the `<Toaster>` component
 * subscribes and renders them in a fixed bottom-right stack. Each toast auto-
 * dismisses after 4s and is dismissible on click.
 */
