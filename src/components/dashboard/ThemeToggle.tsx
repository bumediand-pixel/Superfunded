'use client';
/**
 * Comutator dashboard între dark și light, cu persistență în localStorage.
 * Aplicăm `data-theme` direct pe <html> ca să-l vadă orice descendent (toate
 * variabilele --dash-* sunt definite pe selectorul [data-theme=...] în
 * globals.css).
 */
