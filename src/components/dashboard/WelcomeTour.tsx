...
/**
 * Onboarding modal shown on the first dashboard visit. Branches by whether the
 * user already has a paid plan: brand-new accounts see a "buy a challenge first"
 * step, returning paid users see the operational walkthrough.
 *
 * `hasActiveAccount` is supplied by the dashboard server component so the modal
 * never claims the user "bought a challenge" when they actually just registered.
 */
const STEPS_NEW = [
